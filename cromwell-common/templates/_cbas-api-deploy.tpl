{{- define "cromwell-common.cbas-api-deploy.tpl" -}}
apiVersion: apps/v1
kind: Deployment
metadata:
...
{{- end -}}
{{- define "cromwell-common.cbas-api-deploy" -}}
{{- include "cromwell-common.util.merge" (append . "cromwell-common.cbas-api-deploy.tpl") -}}
{{- end -}}