{{- define "cromwell-common.reverse-proxy-config.tpl" -}}
apiVersion: v1
kind: ConfigMap
metadata:
  ...
  {{ .Values.config.proxy.www_file }}: |-
    ...
    <html>
      ...
      <body>
        ...
        <p> Now serving from the CROMWELL-COMMON Library Chart! </p>
...
{{- end -}}
{{- define "cromwell-common.reverse-proxy-config" -}}
{{- include "cromwell-common.util.merge" (append . "cromwell-common.reverse-proxy-config.tpl") -}}
{{- end -}}