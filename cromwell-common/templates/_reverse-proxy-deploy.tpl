{{- define "cromwell-common.reverse-proxy-deploy.tpl" -}}
apiVersion: apps/v1
kind: Deployment
metadata:
    ...
    spec:
      ...
      containers:
        - name: reverse-proxy-container
          ...
          command: ["nginx"]
{{- end -}}
{{- define "cromwell-common.reverse-proxy-deploy" -}}
{{- include "cromwell-common.util.merge" (append . "cromwell-common.reverse-proxy-deploy.tpl") -}}
{{- end -}}