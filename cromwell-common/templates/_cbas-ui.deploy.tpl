{{- define "cromwell-common.cbas-ui-deploy.tpl" -}}
apiVersion: apps/v1
kind: Deployment
metadata:
...
{{- end -}}
{{- define "cromwell-common.cbas-ui-deploy" -}}
{{- include "cromwell-common.util.merge" (append . "cromwell-common.cbas-ui-deploy.tpl") -}}
{{- end -}}